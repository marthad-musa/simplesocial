...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <!--| Site Author |-->
    <meta name="author" content="Marthad Musa">
    <!-- ./Site Author -->
    ...
    <!--| Favicon here |-->
    <link rel="icon" href="<?=ROOT?>/assets/img/favicon.ico" type="image/x-icon">
    <!-- ./Favicon here -->
    ...
    <link rel="stylesheet" href="<?=ROOT?>/assets/css/stylesheet.css">
    <!-- ./CSS STYLE -->
  ...
  <body>
    <?php
      if (URL('page') != 'login' && URL('page') != 'signup') {
        $this->view('includes/daylight');
